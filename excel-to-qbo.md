...
<article style="max-width:90%;margin:40px auto;padding:10px 20px;line-height:1.7;font-family:Arial,sans-serif;">
  ...
  <section id="how-it-works"><h2>How to convert – 3 simple steps</h2><ol><li>Upload your Excel file</li><li>Select a sheet (if multiple)</li><li>Map columns if needed, then convert and download .qbo</li></ol></section>
